# Generated by Django 3.2.4 on 2021-10-31 00:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='anon', max_length=40, null=True)),
                ('inquiry', models.TextField(max_length=250, null=True)),
                ('time', models.DateTimeField(auto_now_add=True, null=True)),
                ('person', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='profiles.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
